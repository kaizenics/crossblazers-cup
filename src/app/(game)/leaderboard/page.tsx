      ...
      >
        <Card className="border border-white/30 bg-white/20 text-white">
          <CardHeader className="p-6">
            <CardTitle className="font-raceSport text-3xl font-bold text-center">Trivia Leaderboard</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="font-montserrat text-white">Name</TableHead>
                  <TableHead className="font-montserrat text-white">Score</TableHead>
                  <TableHead className="font-montserrat text-white">Games Played</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                <AnimatePresence>
