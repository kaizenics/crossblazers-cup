    ...
    <>
      ...
      <div className="relative w-full h-full py-36 sm:py-0 md:h-[500px] flex flex-col justify-center items-center">
        ...
        <div className="z-10 text-white text-center px-4">
          <h1 className="font-raceSport text-4xl md:text-6xl mb-4">Integrity of Creation</h1>
          <p className="font-montserrat text-xl md:text-2xl">Mt. Apo as Habitat for Humanity</p>
        </div>
      </div>
      ...
      <Container variant={"fullMobileBreakpointPadded"}>
        <div className='max-w-3xl mx-auto py-16 space-y-20'>
          <section>
            <h2 className='font-raceSport text-2xl md:text-3xl text-emerald-500 mb-6'>
              Mount Apo: The Crown of Mindanao
            </h2>
            <p className='font-montserrat text-gray-200 leading-relaxed text-lg'>
